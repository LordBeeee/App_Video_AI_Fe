...
//             {/* Ratio */}
//             {/* <div className="mb-5">
//                 <p className="mb-2 text-sm text-slate-300">Video Ratio</p>

//                 <div className="grid grid-cols-3 overflow-hidden rounded-lg bg-[#222328]">
//                 {[
//                     { value: "16:9", icon: "crop_landscape" },
//                     { value: "1:1", icon: "crop_square" },
//                     { value: "9:16", icon: "crop_portrait" },
//                 ].map((item) => (
//                     <button
//                     key={item.value}
//                     type="button"
//                     onClick={() => setRatio(item.value)}
//                     className={`flex flex-col items-center gap-2 py-3 text-sm transition ${
//                         ratio === item.value
//                         ? "bg-[#3a3b40] text-white"
//                         : "text-slate-300 hover:bg-white/5"
//                     }`}
